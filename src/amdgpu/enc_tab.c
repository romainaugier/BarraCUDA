 ...
 * GFX11 (gfx1100, RDNA 3) opcodes extracted by assembling with llvm-mc
 * and reading the bones. GFX10 table to follow once someone brave enough
 * volunteers to read *that* ISA manual too.
 */
